...
public class constants {
    ...
    static final double BASE_STICK_IN_STALL = -0.33014843749999985;
    static final double BASE_STICK_OUT_STALL = 0.35;
    ...
    static final int HOLD_IN_BUTTON = 11;
    static final int HOLD_OUT_BUTTON = 12;
    ...
    static final int DEPLOY_HOOK_BUTTON = 4;
    static final int RETRACT_HOOK_BUTTON = 6;
